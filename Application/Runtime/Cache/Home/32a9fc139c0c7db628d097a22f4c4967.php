		    ...
		    <nav class="navbar navbar-inverse navbar-fixed-top">
		      <div class="container-fluid">
		        <div class="navbar-header">
		          ...
		          <a class="navbar-brand" href="<?php echo U('Home/Index/index');?>">欢迎访问本系统</a>
		        </div>
  		...
  		<div class="row">
		        <div class="col-md-2 sidebar">
		          <ul class="nav nav-sidebar">
		            ...
		            <li ><a href="<?php echo U('Home/Index/auth');?>">权限管理
						</a></li>
    ...
    <div class="panel panel-primary top">
        <div class="panel-heading">
            <div class="row">
                ...
                <a href="<?php echo U('Home/Index/users_add');?>" class="col-xs-1 col-xs-offset-6 btn btn-warning btn-xs">添加用户组</a>
            </div>
        </div>
